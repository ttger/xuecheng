...
//    private static final StringRedisTemplate redisTemplate = SpringUtil.getBean("stringRedisTemplate");
...
//    private static final RedisTemplate<String, Object> redisTemplate = SpringUtil.getBean("redisTemplate", RedisTemplate.class);
     ...
     * @param timeout 有效期，单位秒
     */
    public static void set(final String key, String value, final long timeout) {
